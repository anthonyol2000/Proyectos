<?php 
/*
    Plugin Name: Utic - Post Types
    Plugin URI:
    Description: Añade Post Types al sitio Utic
    Version: 1.0.0
    Author:Anthony Olarte Lopez
    Author URI: 
    Text Domain: Utic
*/
...
function gymfitness_clases_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Proyectos', 'Post Type General Name', 'gymfitness' ),
		'singular_name'         => _x( 'Proyecto', 'Post Type Singular Name', 'gymfitness' ),
		'menu_name'             => __( 'Proyectos', 'gymfitness' ),
		'name_admin_bar'        => __( 'Proyecto', 'gymfitness' ),
		'archives'              => __( 'Archivo', 'gymfitness' ),
		'attributes'            => __( 'Atributos', 'gymfitness' ),
		'parent_item_colon'     => __( 'Clase Padre', 'gymfitness' ),
		'all_items'             => __( 'Todos los Proyectos', 'gymfitness' ),
		'add_new_item'          => __( 'Agregar Proyecto', 'gymfitness' ),
		'add_new'               => __( 'Agregar Proyecto', 'gymfitness' ),
		'new_item'              => __( 'Nuevo Proyecto', 'gymfitness' ),
		'edit_item'             => __( 'Editar Proyecto', 'gymfitness' ),
		'update_item'           => __( 'Actualizar Proyecto', 'gymfitness' ),
		'view_item'             => __( 'Ver Proyecto', 'gymfitness' ),
		'view_items'            => __( 'Ver Proyectos', 'gymfitness' ),
		'search_items'          => __( 'Buscar Proyecto', 'gymfitness' ),
